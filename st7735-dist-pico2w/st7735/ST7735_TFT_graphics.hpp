...
class ST7735_TFT_graphics : public Print {
 ...
 public:
	...
	uint8_t CurrentFontWidth() { return this->_CurrentFontWidth; }
	uint8_t CurrentFontHeight() { return this->_CurrentFontheight; }
	uint8_t Width() { return this->_widthTFT; }
	uint8_t Height() { return this->_heightTFT; }
    ...
    void TFTdrawBitmap16FullScreen(uint16_t *buffer);
